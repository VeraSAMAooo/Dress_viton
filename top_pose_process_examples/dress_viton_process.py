...
def post_process_viton_top_image(result_raw_image,origin_c_image,b_parse_image,agnostic_mask,
    ...
    kernel_size = (round(10*input_h/512), round(10*input_h/512))
...
if __name__ == '__main__':
    ...
    pose_name = '10'
    result_raw_image_dir = '/home/vera/myCode/top_pose_process_examples/dress_dataset/viton_result/10.png'
    result_parse_image_dir = '/home/vera/myCode/top_pose_process_examples/dress_dataset/viton_result_parse_atr/10.png'
    origin_c_image_path = '/home/vera/myCode/top_pose_process_examples/dress_dataset/image/10.jpg'
    b_parse_image_path = '/home/vera/myCode/top_pose_process_examples/dress_dataset/image-parse-v3-atr/10.png'
    agnostic_mask_path = '/home/vera/myCode/top_pose_process_examples/dress_dataset/agnostic_mask/10.png'
    input_h = 1024
    # f_image_path = './dress_dataset/full_image/{}.jpg'.format(pose_name)
    # body_parse_path = '/home/vera/myCode/top_pose_process_examples/dress_dataset/body_parse/{}.png'.format(pose_name)
    # bbox_file_path = './dress_dataset/kp_bbox_map.json'
    ...
    des_dir = '/home/vera/myCode/top_pose_process_examples/dress_dataset/output1'
    des_png_dir = '/home/vera/myCode/top_pose_process_examples/dress_dataset/output_png1'
    ...
    result_raw_image = cv2.imread(result_raw_image_dir)
    ori_result_parse_image = Image.open(result_parse_image_dir)
    ori_result_parse_image = np.asarray(ori_result_parse_image)
    ...
    result = result.save(os.path.join(des_dir, '20.png'))

    # cv2.imwrite(os.path.join(des_dir, '33.png'),result)
    ...
    #                              ori_result_parse_image,top_labels,input_h=1024)
    #     cv2.imwrite(os.path.join(des_dir,'10.png'.format(name)),result)
        #### get full png result
        # result = post_process_viton_top_image(result_raw_image,origin_c_image,b_parse_image,agnostic_mask,
